...
class Monitoring extends CI_Model
{
     ...
     * @return   bool
     */
    public function update_status($seq, $status, $cnt)
    {
    	...
    	if ($status == 1)
    	{
	    	$setData = array(
	    			'mn_status'         => $status,
	    			'mn_search_start_g' => date("Y-m-d H:i:s", $time),
	    			'mn_search_end_g'   => NULL,
	    			'mn_cnt_g'          => $cnt,
	    	);
    	} elseif ($status == 2) {
    		$setData = array(
    				'mn_status'         => $status,
    				'mn_search_end_g'   => date("Y-m-d H:i:s", $time),
    				'mn_cnt_g'          => $cnt,
    		);
    	} elseif ($status == 3) {
    		$setData = array(
    				'mn_status'         => $status,
    				'mn_search_start_y' => date("Y-m-d H:i:s", $time),
    				'mn_search_end_y'   => NULL,
    				'mn_cnt_y'          => $cnt,
    		);
    	} elseif ($status == 4) {
    		$setData = array(
    				'mn_status'         => $status,
    				'mn_search_end_y'   => date("Y-m-d H:i:s", $time),
    				'mn_cnt_y'          => $cnt,
    		);
    	} else {
    		$setData = array(
