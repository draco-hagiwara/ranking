...
class Project extends CI_Model
{
     ...
     * @return   array()
     */
    public function get_search_data($client_no)
    {
        ...
        $sql .= ' WHERE pj_status != 2
        		    AND ((pj_accounting = 0) OR (pj_accounting = 2))
        		    AND pj_engine != \'00\'
        		';

        $sql .= ' ORDER BY pj_seq ASC';
...
//      * @return   array()
//      */
//     public function get_location_id($location_id, $db_name='default')
//     {
...
//                   lo_criteria_id,
//                   lo_canonical_name
//                 FROM ' . $tb_name . ' WHERE lo_criteria_id = ' . $location_id
//         ;
...
//      * @return   array()
//      */
//     public function get_location_list($db_name='default')
//     {
