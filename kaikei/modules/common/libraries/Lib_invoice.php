...
class Lib_invoice
{
     ...
     * @return int
     */
    public static function issue_num($cm_seq, $date_yymm, $sales_info, $_invo_serial_num, $invo_info, $invo_re, $invo_class)
    {
    ...
    public static function issue_collect($cm_collect, $issue_yymm)
    {
        ...
        switch( $cm_collect ){                                                                // 振込期日 ← 発行日基準
            ...
            case 6:
                ...
                $date = new DateTime($_create_date);
                $collect_date['sales_yymm'] = $date->modify('last day of last months')->format('Ym');
//                 $collect_date['sales_yymm'] = $date->modify('-2 months')->format('Ym');        // ※2月や30日⇔31日で売上月度が変わるので注意！
