{* ヘッダー部分　START *}
  ...
  {*<script src="{base_url()}../../js/repeater/jquery-1.11.1.js"></script>*}
...
<H3><p class="bg-success">　　支払先情報　新規登録</p></H3>

{*form_open('shokailist/addchk/' , 'name="addForm" class="form-horizontal h-adr"')*}
{form_open('shokailist/addchk/' , 'name="addForm" class="form-horizontal h-adr repeater"')}
  {$mess}
  <div class="form-group">
    <label for="sk_status" class="col-sm-3 control-label">ステータス選択<font color=red> *</font></label>
    <div class="col-sm-5 btn-lg">
      {form_dropdown('sk_status', $options_sk_status, set_value('sk_status', ''))}
  ...
  <div class="form-group">
    <label for="sk_salesman" class="col-md-3 control-label">担当営業<font color=red> *</font></label>
    <div class="col-md-2 btn-lg">
      {form_dropdown('sk_salesman', $options_sk_salesman, set_value('sk_salesman', ''))}
      {if form_error('sk_salesman')}<span class="label label-danger">Error : </span><label><font color=red>{form_error('sk_salesman')}</font></label>{/if}
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-md-9 btn-lg">
      <div data-repeater-list="group-cm">
        <div data-repeater-item>
          {form_dropdown('skc_cm_seq', $options_cm_company, set_value('skc_cm_seq', ''))}
          <input data-repeater-delete type="button" value="削除"/>
          {if form_error('skc_cm_seq')}<br><span class="label label-danger">Error : </span><label><font color=red>{form_error('skc_cm_seq')}</font></label>{/if}
        </div>
      </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <label class="radio-inline">
        <input type="radio" name="sk_tax_out" id="inlineRadio1" value="1" checked> 内税
      </label>
      <label class="radio-inline">
        <input type="radio" name="sk_tax_out" id="inlineRadio2" value="0"> 外税
      </label>
    </div>
  </div>
  {*<div class="form-group">
    ...
    <div class="col-xs-3 col-md-2">
      固定金額：{form_input('sk_paycal_fix' , set_value('sk_paycal_fix', '') , 'class="form-control" placeholder="固定金額"')}
    ...
    <div class="col-xs-3 col-md-2">
      料率：{form_input('sk_paycal_rate' , set_value('sk_paycal_rate', '') , 'class="form-control" placeholder="料率"')}
  ...
  *}
  <div class="form-group">
    ...
    <div class="col-sm-2 btn-lg">
      {form_dropdown('sk_payment', $options_sk_payment, set_value('sk_payment', ''))}
      {if form_error('sk_payment')}<span class="label label-danger">Error : </span><label><font color=red>{form_error('sk_payment')}</font></label>{/if}
    </div>
  </div>
  <div class="form-group">
    <label for="sk_company" class="col-md-3 control-label">会社名<font color=red> *</font></label>
    <div class="col-md-8">
      {form_input('sk_company' , set_value('sk_company', '') , 'class="form-control" placeholder="会社名を入力してください。max.50文字"')}
  ...
  <div class="form-group">
    <label for="sk_company_kana" class="col-md-3 control-label">会社名カナ<font color=red> *</font></label>
    <div class="col-md-2">
      {form_input('sk_company_kana' , set_value('sk_company_kana', '') , 'class="form-control" placeholder="全角カナ。max.4文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-3 col-md-2">
      ...
      {form_input('sk_zip01' , set_value('sk_zip01', '') , 'class="form-control p-postal-code" placeholder="郵便番号（3ケタ）"')}
      {if form_error('sk_zip01')}<span class="label label-danger">Error : </span><label><font color=red>{form_error('sk_zip01')}</font></label>{/if}
    </div>
    <div class="col-xs-3 col-md-2">
      {form_input('sk_zip02' , set_value('sk_zip02', '') , 'class="form-control p-postal-code" placeholder="郵便番号（4ケタ）"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('sk_addr01' , set_value('sk_addr01', '') , 'class="form-control p-locality" placeholder="市区町村を入力してください。 max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('sk_addr02' , set_value('sk_addr02', '') , 'class="form-control p-street-address" placeholder="町名・番地を入力してください。 max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('sk_buil' , set_value('sk_buil', '') , 'class="form-control p-extended-address" placeholder="ビル・マンション名などを入力してください。 max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      {form_input('sk_president01' , set_value('sk_president01', '') , 'class="form-control" placeholder="代表者姓を入力してください。max.50文字"')}
    ...
    <div class="col-md-4">
      {form_input('sk_president02' , set_value('sk_president02', '') , 'class="form-control" placeholder="代表者名を入力してください。max.50文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2 col-md-2">
      {form_input('sk_tel01' , set_value('sk_tel01', '') , 'class="form-control" placeholder="代表電話番号を入力"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('sk_mail' , set_value('sk_mail', '') , 'class="col-md-4 form-control" placeholder="メールアドレスを入力してください。max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('sk_mailsub' , set_value('sk_mailsub', '') , 'class="col-md-4 form-control" placeholder="メールアドレスを入力してください。max.100文字"')}
  ...
  <div class="form-group">
    <label for="sk_department" class="col-md-3 control-label">担当所属部署／役職</label>
    <div class="col-md-8">
      {form_input('sk_department' , set_value('sk_department', '') , 'class="form-control" placeholder="所属部署を入力してください。max.50文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      {form_input('sk_person01' , set_value('sk_person01', '') , 'class="form-control" placeholder="担当者姓を入力してください。max.50文字"')}
    ...
    <div class="col-md-4">
      {form_input('sk_person02' , set_value('sk_person02', '') , 'class="form-control" placeholder="担当者名を入力してください。max.50文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2 col-md-2">
      {form_input('sk_tel02' , set_value('sk_tel02', '') , 'class="form-control" placeholder="担当者電話番号を入力"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2 col-md-2">
      {form_input('sk_mobile' , set_value('sk_mobile', '') , 'class="form-control" placeholder="担当者携帯番号を入力"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2 col-md-2">
      {form_input('sk_fax' , set_value('sk_fax', '') , 'class="form-control" placeholder="FAX番号を入力"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2 col-md-2">
      {form_input('sk_bank_cd' , set_value('sk_bank_cd', '') , 'class="form-control" placeholder="銀行CDを入力"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('sk_bank_nm' , set_value('sk_bank_nm', '') , 'class="form-control" placeholder="銀行名を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2 col-md-2">
      {form_input('sk_branch_cd' , set_value('sk_branch_cd', '') , 'class="form-control" placeholder="支店CDを入力"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('sk_branch_nm' , set_value('sk_branch_nm', '') , 'class="form-control" placeholder="支店名を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2 btn-lg">
      {form_dropdown('sk_kind', $options_sk_kind, set_value('sk_kind', ''))}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2 col-md-2">
      {form_input('sk_account_no' , set_value('sk_account_no', '') , 'class="form-control" placeholder="口座番号を入力"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('sk_account_nm' , set_value('sk_account_nm', '') , 'class="form-control" placeholder="口座名義(半角カナ)を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <textarea class="form-control input-sm" id="sk_memo" name="sk_memo" placeholder="max.1000文字">{$tmp_memo}</textarea>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">支払先情報　登録</h4>
        </div>
