...
{form_open_multipart('/data_csvup/receive_csvup/' , 'name="datachkForm" class="form-horizontal"')}

  <div class="row">
    <label for="cl_detail" class="col-xs-4 col-md-4 control-label">【入金データCSV：アップロード】</label>
  ...
  <div class="row">
    ...
    <font color="red">・ファイル名は英数字のみです。</font><br>
  ...
  <div class="row">
    <div class="col-sm-offset-4 col-sm-8">
      <label><font color={$up_mess01[0]}>{$up_mess01[1]}</font></label>
    </div>
  </div>
