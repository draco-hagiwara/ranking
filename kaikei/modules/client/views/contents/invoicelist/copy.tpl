...
<H3><p class="bg-success">　　顧客情報　複写 ＆ 新規登録</p></H3>

{form_open('/customerlist/cpchk/' , 'name="customerDetailForm" class="form-horizontal h-adr"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('cm_tel01' , set_value('cm_tel01', $info.cm_tel01) , 'class="form-control" placeholder="代表電話番号を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('cm_tel02' , set_value('cm_tel02', $info.cm_tel02) , 'class="form-control" placeholder="担当者電話番号を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('cm_mobile' , set_value('cm_mobile', $info.cm_mobile) , 'class="form-control" placeholder="担当者携帯番号を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('cm_fax' , set_value('cm_fax', $info.cm_fax) , 'class="form-control" placeholder="FAX番号を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('cm_bank_cd' , set_value('cm_bank_cd', $info.cm_bank_cd) , 'class="form-control" placeholder="銀行CDを入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('cm_branch_cd' , set_value('cm_branch_cd', $info.cm_branch_cd) , 'class="form-control" placeholder="支店CDを入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('cm_account_no' , set_value('cm_account_no', $info.cm_account_no) , 'class="form-control" placeholder="口座番号を入力してください"')}
