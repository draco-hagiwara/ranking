...
{form_open('projectlist/addchk/' , 'name="accountForm" class="form-horizontal"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2 btn-lg">
      {form_dropdown('pj_status', $options_pj_status, set_value('pj_status', ''))}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2 btn-lg">
      {form_dropdown('pj_invoice_status', $options_pj_iv_type, set_value('pj_invoice_status', ''))}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-2">
      {form_input('pj_orders_start' , set_value('pj_orders_start', '') , 'id="mydate4" class="form-control" placeholder="契約開始年月日"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-2">
      {form_input('pj_end_date' , set_value('pj_end_date', '') , 'id="mydate2" class="form-control" placeholder="終了日"')}
...
*}
  <div class="form-group">
    ...
    <div class="col-xs-8 col-md-8">
      {form_input('pj_keyword' , set_value('pj_keyword', '') , 'class="form-control" placeholder="検索キーワードを入力してください。max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-8 col-md-8">
      {form_input('pj_url' , set_value('pj_url', '') , 'class="form-control" placeholder="対象URLを入力してください。max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-2">
      {form_input('pj_billing' , set_value('pj_billing', '') , 'class="form-control"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-2">
      固定金額：{form_input('pj_paycal_fix' , set_value('pj_paycal_fix', '') , 'class="form-control" placeholder="固定金額"')}
    ...
    <div class="col-md-2">
      料率：{form_input('pj_paycal_rate' , set_value('pj_paycal_rate', '') , 'class="form-control" placeholder="料率"')}
