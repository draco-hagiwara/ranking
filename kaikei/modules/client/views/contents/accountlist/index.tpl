    ...
    {foreach from=$list item=ac}
      ...
      <tbody>
        <tr>
          ...
          <td>
            {if $ac.ac_type == "0"}<font color="#ffffff" style="background-color:limegreen">[ 一　般 ]</font>
            {elseif $ac.ac_type == "1"}<font color="#ffffff" style="background-color:deeppink">[ 管理者 ]</font>
            {else}}エラー
            {/if}
          </td>
          <td>
