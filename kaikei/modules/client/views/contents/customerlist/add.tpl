...
<H3><p class="bg-success">　　顧客情報　新規登録</p></H3>
...
{form_open('customerlist/addchk/' , 'name="clientForm" class="form-horizontal h-adr"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-2 btn-lg">
      {form_dropdown('cm_agency_flg', $options_cm_agency_flg, set_value('cm_agency_flg', ''))}
    </div>
  </div>
  <div class="form-group">
    <label for="cm_agency_seq" class="col-xs-3 col-md-3 control-label">代理店　選択</label>
    <div class="col-xs-4 col-md-4 btn-lg">
      {form_dropdown('cm_agency_seq', $options_cm_agency_seq, set_value('cm_agency_seq', ''))}
    </div>
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    <label for="cm_company" class="col-md-3 control-label">会社名<font color=red> *</font></label>
    <div class="col-md-8">
  ...
  <div class="form-group">
    ...
    <div class="col-md-2">
      {form_input('cm_company_kana' , set_value('cm_company_kana', '') , 'class="form-control" placeholder="max.4文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-3 col-md-2">
      ...
      {form_input('cm_zip01' , set_value('cm_zip01', '') , 'class="form-control p-postal-code" placeholder="郵便番号（3ケタ）"')}
      {if form_error('cm_zip01')}<span class="label label-danger">Error : </span><label><font color=red>{form_error('cm_zip01')}</font></label>{/if}
    </div>
    <div class="col-xs-3 col-md-2">
      {form_input('cm_zip02' , set_value('cm_zip02', '') , 'class="form-control p-postal-code" placeholder="郵便番号（4ケタ）"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('cm_addr01' , set_value('cm_addr01', '') , 'class="form-control p-locality" placeholder="市区町村を入力してください。 max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('cm_addr02' , set_value('cm_addr02', '') , 'class="form-control p-street-address" placeholder="町名・番地を入力してください。 max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('cm_buil' , set_value('cm_buil', '') , 'class="form-control p-extended-address" placeholder="ビル・マンション名などを入力してください。 max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      {form_input('cm_president01' , set_value('cm_president01', '') , 'class="form-control" placeholder="代表者姓を入力してください。max.50文字"')}
    ...
    <div class="col-md-4">
      {form_input('cm_president02' , set_value('cm_president02', '') , 'class="form-control" placeholder="代表者名を入力してください。max.50文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-2 col-md-2">
      {form_input('cm_capital' , set_value('cm_capital', '') , 'class="form-control" placeholder="資本金を入力"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2 btn-lg">
      {form_dropdown('cm_pub_company', $options_cm_pub_company, set_value('cm_pub_company', ''))}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('cm_mail' , set_value('cm_mail', '') , 'class="col-md-4 form-control" placeholder="メールアドレスを入力してください。max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('cm_mailsub' , set_value('cm_mailsub', '') , 'class="col-md-4 form-control" placeholder="メールアドレスを入力してください。max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      {form_input('cm_person01' , set_value('cm_person01', '') , 'class="form-control" placeholder="担当者姓を入力してください。max.50文字"')}
    ...
    <div class="col-md-4">
      {form_input('cm_person02' , set_value('cm_person02', '') , 'class="form-control" placeholder="担当者名を入力してください。max.50文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('cm_bank_nm' , set_value('cm_bank_nm', '') , 'class="form-control" placeholder="銀行名を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('cm_branch_nm' , set_value('cm_branch_nm', '') , 'class="form-control" placeholder="支店名を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-sm-2 btn-lg">
      {form_dropdown('cm_kind', $options_cm_kind, set_value('cm_kind', ''))}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-4 col-md-4">
      {form_input('cm_account_nm' , set_value('cm_account_nm', '') , 'class="form-control" placeholder="口座名義(半角カナ)を入力してください"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <textarea class="form-control input-sm" id="cm_memo" name="cm_memo" placeholder="max.1000文字">{$tmp_memo}</textarea>
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      <textarea class="form-control input-sm" id="cm_memo_iv" name="cm_memo_iv" placeholder="max.100文字">{$tmp_memo_iv}</textarea>
  ...
  <div class="form-group">
    <div class="col-sm-offset-3 col-sm-8">
      {form_checkbox('chkinvoice[]','1',set_checkbox('chkinvoice[]', '1'))}請求書の送付先が異なる場合にはチェックを入れて下記に記入してください。
    </div>
  </div>
  <div class="form-group">
    <label for="cm_company_iv" class="col-md-3 control-label">請求書：会社名</label>
    <div class="col-md-8">
      {form_input('cm_company_iv' , set_value('cm_company_iv', '') , 'class="form-control" placeholder="会社名を入力してください。max.50文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-3 col-md-2">
      {form_input('cm_zip01_iv' , set_value('cm_zip01_iv', '') , 'class="form-control" placeholder="郵便番号（3ケタ）"')}
    ...
    <div class="col-xs-3 col-md-2">
      {form_input('cm_zip02_iv' , set_value('cm_zip02_iv', '') , 'class="form-control" placeholder="郵便番号（4ケタ）"')}
  ...
  <div class="form-group">
    ...
    <div class="col-xs-3 col-md-2 btn-lg">
        <select name="cm_pref_iv">
            <option value=""> -- 選択してください -- </option>
            <option value="北海道" {if $tmp_pref_iv=="北海道"}selected{/if}>北海道</option>
            <option value="青森県" {if $tmp_pref_iv=="青森県"}selected{/if}>青森県</option>
            <option value="岩手県" {if $tmp_pref_iv=="岩手県"}selected{/if}>岩手県</option>
            <option value="宮城県" {if $tmp_pref_iv=="宮城県"}selected{/if}>宮城県</option>
            <option value="秋田県" {if $tmp_pref_iv=="秋田県"}selected{/if}>秋田県</option>
            <option value="山形県" {if $tmp_pref_iv=="山形県"}selected{/if}>山形県</option>
            <option value="福島県" {if $tmp_pref_iv=="福島県"}selected{/if}>福島県</option>
            <option value="茨城県" {if $tmp_pref_iv=="茨城県"}selected{/if}>茨城県</option>
            <option value="栃木県" {if $tmp_pref_iv=="栃木県"}selected{/if}>栃木県</option>
            <option value="群馬県" {if $tmp_pref_iv=="群馬県"}selected{/if}>群馬県</option>
            <option value="埼玉県" {if $tmp_pref_iv=="埼玉県"}selected{/if}>埼玉県</option>
            <option value="千葉県" {if $tmp_pref_iv=="千葉県"}selected{/if}>千葉県</option>
            <option value="東京都" {if $tmp_pref_iv=="東京都"}selected{/if}>東京都</option>
            <option value="神奈川県" {if $tmp_pref_iv=="神奈川県"}selected{/if}>神奈川県</option>
            <option value="新潟県" {if $tmp_pref_iv=="新潟県"}selected{/if}>新潟県</option>
            <option value="富山県" {if $tmp_pref_iv=="富山県"}selected{/if}>富山県</option>
            <option value="石川県" {if $tmp_pref_iv=="石川県"}selected{/if}>石川県</option>
            <option value="福井県" {if $tmp_pref_iv=="福井県"}selected{/if}>福井県</option>
            <option value="山梨県" {if $tmp_pref_iv=="山梨県"}selected{/if}>山梨県</option>
            <option value="長野県" {if $tmp_pref_iv=="長野県"}selected{/if}>長野県</option>
            <option value="岐阜県" {if $tmp_pref_iv=="岐阜県"}selected{/if}>岐阜県</option>
            <option value="静岡県" {if $tmp_pref_iv=="静岡県"}selected{/if}>静岡県</option>
            <option value="愛知県" {if $tmp_pref_iv=="愛知県"}selected{/if}>愛知県</option>
            <option value="三重県" {if $tmp_pref_iv=="三重県"}selected{/if}>三重県</option>
            <option value="滋賀県" {if $tmp_pref_iv=="滋賀県"}selected{/if}>滋賀県</option>
            <option value="京都府" {if $tmp_pref_iv=="京都府"}selected{/if}>京都府</option>
            <option value="大阪府" {if $tmp_pref_iv=="大阪府"}selected{/if}>大阪府</option>
            <option value="兵庫県" {if $tmp_pref_iv=="兵庫県"}selected{/if}>兵庫県</option>
            <option value="奈良県" {if $tmp_pref_iv=="奈良県"}selected{/if}>奈良県</option>
            <option value="和歌山県" {if $tmp_pref_iv=="和歌山県"}selected{/if}>和歌山県</option>
            <option value="鳥取県" {if $tmp_pref_iv=="鳥取県"}selected{/if}>鳥取県</option>
            <option value="島根県" {if $tmp_pref_iv=="島根県"}selected{/if}>島根県</option>
            <option value="岡山県" {if $tmp_pref_iv=="岡山県"}selected{/if}>岡山県</option>
            <option value="広島県" {if $tmp_pref_iv=="広島県"}selected{/if}>広島県</option>
            <option value="山口県" {if $tmp_pref_iv=="山口県"}selected{/if}>山口県</option>
            <option value="徳島県" {if $tmp_pref_iv=="徳島県"}selected{/if}>徳島県</option>
            <option value="香川県" {if $tmp_pref_iv=="香川県"}selected{/if}>香川県</option>
            <option value="愛媛県" {if $tmp_pref_iv=="愛媛県"}selected{/if}>愛媛県</option>
            <option value="高知県" {if $tmp_pref_iv=="高知県"}selected{/if}>高知県</option>
            <option value="福岡県" {if $tmp_pref_iv=="福岡県"}selected{/if}>福岡県</option>
            <option value="佐賀県" {if $tmp_pref_iv=="佐賀県"}selected{/if}>佐賀県</option>
            <option value="長崎県" {if $tmp_pref_iv=="長崎県"}selected{/if}>長崎県</option>
            <option value="熊本県" {if $tmp_pref_iv=="熊本県"}selected{/if}>熊本県</option>
            <option value="大分県" {if $tmp_pref_iv=="大分県"}selected{/if}>大分県</option>
            <option value="宮崎県" {if $tmp_pref_iv=="宮崎県"}selected{/if}>宮崎県</option>
            <option value="鹿児島県" {if $tmp_pref_iv=="鹿児島県"}selected{/if}>鹿児島県</option>
            <option value="沖縄県" {if $tmp_pref_iv=="沖縄県"}selected{/if}>沖縄県</option>
        </select>
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('cm_addr01_iv' , set_value('cm_addr01_iv', '') , 'class="form-control" placeholder="市区町村を入力してください。 max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('cm_addr02_iv' , set_value('cm_addr02_iv', '') , 'class="form-control" placeholder="町名・番地を入力してください。 max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-8">
      {form_input('cm_buil_iv' , set_value('cm_buil_iv', '') , 'class="form-control p-extended-address" placeholder="ビル・マンション名などを入力してください。 max.100文字"')}
  ...
  <div class="form-group">
    ...
    <div class="col-md-4">
      {form_input('cm_person01_iv' , set_value('cm_person01_iv', '') , 'class="form-control" placeholder="担当者姓を入力してください。max.50文字"')}
    ...
    <div class="col-md-4">
      {form_input('cm_person02_iv' , set_value('cm_person02_iv', '') , 'class="form-control" placeholder="担当者名を入力してください。max.50文字"')}
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">顧客情報　登録</h4>
        </div>
