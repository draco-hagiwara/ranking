	...
	<tr><!--各テーブルヘッダはクリックするとソートする。-->
	  ...
	  <th id="wl_sort_id" class="wl_sort_cl"></th><!--一括ウォッチリストではない。単なるソート-->
	  <th class="t_l group_sort_cl" id="group_sort_id">グループ</th>
	  <th class="t_l keyword_sort_cl" id="keyword_sort_id">キーワード</th>
	  <th colspan="2" class="url_sort_cl" id="url_sort_id"><!--URLは一定文字数以上は省略する。30文字程度？-->
		<p class="f_l no_space">URL</p>
		<p class="f_r no_space">マッチタイプ</p>
	  </th>
	  <th id="location_sort_id">地域</th>
	  <th colspan="4" id="gpc_sort_id"><img src="/images/user/monitor.png" width="16" /><img src="/images/user/google_favicon.png" /></th>
	  <th colspan="2" id="gmo_sort_id"><img src="/images/user/smartphone.png" width="16" /><img src="/images/user/google_favicon.png" /></th>
	  <th colspan="2" id="ypc_sort_id"><img src="/images/user/monitor.png" width="16" style="margin-right: 2px;" /><img src="/images/user/yahoo_favicon.png" /></th>
	</tr>
	...
	<tr>
	  <td class="checkbox_kw{$cnt}"><input type="checkbox" name="checkbox_kwseq[]" value="{$kw.kw_seq}" /></td>
	  <td>
	  ...
	  <td class="jqPlot-show{$cnt} t_l">{if $kw.kw_group}{$kw.kw_group}{else}-{/if}</td>
	  <td class="jqPlot-show{$cnt} t_l">{$kw.kw_keyword}</td>
	  <td class="t_l"><a href="{$kw.kw_url}" target="_blank">{$kw.kw_url}</a></td>
	  <td class='jqPlot-show{$cnt}'>
    ...
    <tr>
      ...
      {* Graph *}
      {*include file="../../../../../public/js/my/searchrank_jqplot_gp.php"*}
      {* slideDown *}
      {include file="../../../../../public/js/my/searchrank_jqplot_show.php"}
    </tr>
    ...
    {include file="../../../../../public/js/my/searchrank_chkbox.php"}

    {* ウォッチリスト追加 & 削除時の操作 *}
    {include file="../../../../../public/js/my/searchrank_watchlist.php"}

    {* テーブルヘッダをマウスクリックによる昇順降順並替 *}
    {include file="../../../../../public/js/my/searchrank_sort.php"}
