	...
	<tr><!--各テーブルヘッダはクリックするとソートする。-->
	  ...
	  <th class="location_sort_cl" id="location_sort_id">地域</th>
	  <th colspan="4" class="gpc_sort_cl" id="gpc_sort_id"><img src="/images/user/monitor.png" width="16" /><img src="/images/user/google_favicon.png" /></th>
	  <th colspan="2" class="gmo_sort_cl" id="gmo_sort_id"><img src="/images/user/smartphone.png" width="16" /><img src="/images/user/google_favicon.png" /></th>
	  <th colspan="2" class="ypc_sort_cl" id="ypc_sort_id"><img src="/images/user/monitor.png" width="16" style="margin-right: 2px;" /><img src="/images/user/yahoo_favicon.png" /></th>
	</tr>
