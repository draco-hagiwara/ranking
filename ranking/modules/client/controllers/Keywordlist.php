...
//     	print("<br><br>");
        ...
        {
        	$get_me_data = $this->me->get_me_kwseq($kw_list[$key]['kw_seq']);
        	foreach ($get_me_data as $key1 => $value1)
        	{
        		$get_me_list[$kw_list[$key]['kw_seq']][$key1] = $value1['me_memo'];
        	}
        }
...
//     	$this->view('keywordlist/del_pw.tpl');
...
//     // 対象URLの存在チェック （クロスドメイン）
//     public function kwurl_chk()
//     {
