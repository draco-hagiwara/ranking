...
{form_open_multipart('/data_csv/kwlist_csvup/' , 'name="dataForm" class="form-horizontal"')}
  ...
  <div class="row">
    <div class="col-sm-offset-2 col-sm-10">
      <br>・ファイルフォーマットは「キーワード管理一覧」よりダウンロードされるファイルに準じます。
      <br>・一行目は項目欄となり、読み飛ばされます。
      <br>・一列目の「seq」にID番号が設定されていない場合は追加、設定されている場合は既存情報の更新となります。
      <br>・
      <button type="button" class="btn btn-default  btn-sm" data-container="body" data-toggle="popover" data-placement="right"
        data-content="<b>【ステータス】</b><br>&emsp;1：有効，0：無効<br>
                      <b>【URL一致方式】</b><br>&emsp;0：完全一致，1：前方一致，2：ドメイン一致，3：ルートドメイン一致<br>
...
{form_open_multipart('/data_csv/criteria_csvup/' , 'name="dataForm" class="form-horizontal"')}
  ...
  <div class="row">
    <div class="col-sm-offset-2 col-sm-10">
      <br>・基準ファイルのダウンロード先 ⇒ <a href="https://developers.google.com/adwords/api/docs/appendix/geotargeting">Geotargets</a>
      <br>・一行目は項目欄となり、読み飛ばされます。
    </div>
  </div>
  <div class="row">
