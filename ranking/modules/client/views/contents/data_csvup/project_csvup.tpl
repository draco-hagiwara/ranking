...
{form_open_multipart('/data_csvup/project_csvup/' , 'name="dataForm" class="form-horizontal"')}

  <div class="form-group form-group-lg">
    <label for="cl_detail" class="col-xs-4 col-md-5 control-label">【キーワード（受注）情報CSV：アップロード】</label>
  </div>
  ...
  <div class="row">
    <div class="col-sm-offset-2 col-sm-10">
      ...
      <br>・一列目の「cm_seq」に受注番号が設定されていない場合は追加、設定されている場合は既存情報の更新となります。
      <br>・
...
{form_open('/data_csvup/project_csvdown/' , 'name="dataForm" class="form-horizontal"')}

  <div class="form-group form-group-lg">
    <label for="cl_detail" class="col-xs-4 col-md-4 control-label">【キーワード情報CSV：ダウンロード】</label>
  </div>
  <div class="row">
    <div class="col-sm-offset-2 col-sm-10">
      <br>・受注情報の全件をダウンロードします。
  ...
  <div class="modal fade" id="myModal02" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          <h4 class="modal-title">受注情報のCSVダウンロード</h4>
        </div>
        <div class="modal-body">
