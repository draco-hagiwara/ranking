...
<H4><p class="bg-success">&emsp;&emsp;タグ管理&emsp;編集</p></H4>

{form_open('taglist/chg_conf/' , 'name="detailForm" class="form-horizontal repeater"')}

  {if $disp01==FALSE}
  <div class="form-group">
    <label for="gt_name" class="col-md-2 control-label">タグ名の更新</label>
    <div class="col-md-8">
...
{if $disp01==TRUE}
{form_open('taglist/chg_comp/' , 'name="detailForm" class="form-horizontal repeater"')}

  {if $disp01==TRUE}
  <div class="form-group">
    <label for="gt_name" class="col-md-2 control-label">タグ名の更新</label>
    <div class="col-md-7">
      {form_input('gt_name' , set_value('gt_name', {$gt_name}) , 'class="form-control" placeholder="タグ名を入力してください。max.50文字"')}
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title">タグ設定　キャンセル</h4>
          </div>
    ...
    <div class="modal fade" id="myModal02" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">タグ設定　更新</h4>
          </div>
          <div class="modal-body">
            <p>更新しますか。&hellip;</p>
          </div>
    ...
    <div class="modal fade" id="myModal03" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
            <h4 class="modal-title">タグ設定　削除</h4>
          </div>
          <div class="modal-body">
            <p>削除しますか。&hellip;</p>
          </div>
...
{form_open('taglist/add_comp/' , 'name="detailForm" class="form-horizontal repeater"')}

  <div class="form-group">
    <label for="new_name" class="col-md-2 control-label">タグ名の追加</label>
    <div class="col-md-7">
      {form_input('new_name' , set_value('new_name', '') , 'class="form-control" placeholder="タグ名を入力してください。max.50文字"')}
