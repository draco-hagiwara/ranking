...
<h4>【タグ内検索】</h4>
{form_open('/taglist/detail_search/' , 'name="searchForm" class="form-horizontal"')}
...
<p>タグ名：{$gt_name}<br>表示期間：{$end_date} ～ {$start_date}</p>
{form_open('/taglist/detail_search/' , 'name="detailForm" class="form-horizontal"')}
