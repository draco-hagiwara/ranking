...
// 			print_r($get_data);
// 			print("<br><br>");
// 			$serialize_hoge = serialize($get_data);
// 			print($serialize_hoge);
// 			print("<br><br>");
// 			exit;
...
// 			$set_ranking_data['rk_result_id']  = md5($_item);
...
// 		log_message('info', '取得リトライが実行されました。検索データ数=' . $_search_cnt . ', 順位取得データ数=' . $_rank_cnt);
		return array($_get_cnt, $_search_cnt, $_rank_cnt);
	}
...
//  	var_dump($_ranking_kwdomain);
// 		print_r($_ranking_kwdomain);
// 		print("<br><br>");


// 		var_dump($_ranking_top);
// 		print_r($_ranking_top);
// 		print("<br><br>");

// 		var_dump($_ranking_up);
// 		print_r($_ranking_up);
// 		print("<br><br>");

// 		var_dump($_ranking_down);
// 		print_r($_ranking_down);
// 		print("<br><br>");

// 		print_r($_ranking_up_cnt);
// 		print("<br>");
// 		print_r($_ranking_down_cnt);
// 		print("<br><br>");
	 ...
	 * @return char
	 */
	public static function get_jqplot_graph11111111111111111($kw_seq, $cnt_date=30)
	{
		...
		$CI->smarty->assign('plot_data', $_plot_data);
		$CI->smarty->assign('plot_start_data', $_end_date);
		$CI->smarty->assign('plot_end_data', $_start_date);
...
// 		print("<br><br>");
	...
	public static function get_jqplot_graph($kw_seq, $term)
	{
		...
		if ($_term[0] === "0")
		{
			...
			//$_end_term   = $get_kw_data[0]['kw_create_date'];
		} else {
